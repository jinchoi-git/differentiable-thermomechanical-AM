...
N_BLOCKS = 10 # power_on_steps // 10 # 50 params for 500 "laser on" steps (10 steps each)
...
def main_function(params):
    ...
    jax.debug.print(
        ...
        tot=total_loss, sl=stress_loss, ml=melt_loss,
    )
...
if __name__ == "__main__":
    ...
    if mode == "gradcheck":
        ...
        found_any = False
        for src in ["adam", "bfgs", "bfgs_h", "bfgs_joint"]:
            try:
