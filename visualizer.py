...
def run_forward(input_control = None, output_path="./analysis"):

    if not input_control:
        control_signal = jnp.ones((power_on_steps))
    ...
    save_vtk(temperatures, S_seq, U_seq, elements, nodes, element_birth, node_birth, dt, out_dir="./analysis", keyword = keyword)
    print("finished")
...
if __name__ == "__main__":
    run_forward(input_control = None, output_path = output_dir)
    run_forward(input_control = "./minimize_stress/control_0730.npy", output_path = output_dir)
